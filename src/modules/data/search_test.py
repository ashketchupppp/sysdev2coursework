...
class TestSearchFcuntion(unittest.TestCase):
    def test_valid_entry(self):
        ...
        {"name": "Help","imdb": 6.2,"category": "Romance"},
        {"name": "Colonia","imdb": 7.4,"category": "Romance"}
        ]
        actualOutput = search_list_dict(movies, "Colonia", "name")
    ...
    def test_invalid_entry(self):
        ...
        {"name": "Help","imdb": 6.2,"category": "Romance"},
        {"name": "Colonia","imdb": 7.4,"category": "Romance"}]
        actualOutput = search_list_dict(movies, "nothere", "name")
        expectedOutput = [-1]
        self.assertEqual(actualOutput, expectedOutput)
    ...
    def test_multiple_entry(self):
        ...
        {"name": "Dark Knight","imdb": 9.0,"category": "Adventure"},
        {"name": "The Help","imdb": 8.0,"category": "Drama"},
        {"name": "Colonia","imdb": 6.2,"category": "Romance"},
        {"name": "Colonia","imdb": 7.4,"category": "Romance"}]
        actualOutput = search_list_dict(movies, "Colonia", "name")
        expectedOutput = [-2]
        self.assertEqual(actualOutput, expectedOutput)
    ...
    def test_invalid_key(self):
        ...
        {"name": "Dark Knight","imdb": 9.0,"category": "Adventure"},
        {"name": "The Help","imdb": 8.0,"category": "Drama"},
        {"name": "test","imdb": 6.2,"category": "Romance"},
        {"name": "Colonia","imdb": 7.4,"category": "Romance"}]
